...
<div class="asc-wrap">
  ...
  <div class="asc-head">
    <div>
      <h1>Curriculum</h1>
      <p class="asc-sub">Manage curriculum entries.</p>
  ...
  <div class="asc-card">
    <table class="asc-table">
      ...
      <tbody>
        ...
        @empty
        <tr>
          <td colspan="3" style="padding:20px;color:#6b7280;">
            No curriculum found.
          </td>
        </tr>
        @endforelse
...
@include('utilities.curriculum.CurriculumModal')
@endsection
...
<div class="asc-wrap">
  ...
  <div class="asc-head">
    <div>
      <h1>Subjects</h1>
      <p class="asc-sub">Manage subject offerings.</p>
      <div style="margin-top:12px;">
        <a href="{{ route('utilities.master-data') }}"
           style="display:inline-flex;align-items:center;gap:8px;
                  padding:8px 14px;border-radius:12px;
                  border:1px solid rgba(91,76,230,.25);
                  background:#fff;color:#4b3fd1;
    ...
    <table class="asc-table">
      <thead>
        <tr>
          ...
          <th style="width:110px;">Lecture</th>
  ...
  <a href="{{ route('utilities.master-data') }}" class="asc-btn asc-btn-secondary" style="display:inline-flex; align-items:center; gap:8px; padding:8px 12px; margin-top:10px; text-decoration:none;">
    <span style="font-weight:900;">←</span> Back
  </a>

</div>

@include('utilities.subjects.SubjectsModal')
@endsection

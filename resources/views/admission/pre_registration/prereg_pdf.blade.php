...
<head>
  ...
  <style>
    @page { size: legal portrait; margin: 12px 12px 12px 12px; }

    body { font-family: DejaVu Sans, Arial, sans-serif; font-size: 11px; color:#111827; }

html, body { padding: 0; margin: 0; }
/* Keep the whole form on a single Legal page and prevent DomPDF table-cell splitting */
.page { page-break-inside: avoid; }
table { page-break-inside: avoid; }
tr, td { page-break-inside: avoid; }
.grid { table-layout: fixed; }
.box, .photo-box { page-break-inside: avoid; }
